...
std::shared_ptr<CController> CControllerConfiguration::CreateController(const std::string& config) const
{
...
std::shared_ptr<CController> CControllerConfiguration::CreateDefaultController() const
{
